...
object Items {
    ...
    fun init() {
        ...
        BOILED_POTATO = Item("Boiled Potato", "boiled_potato").setBaseMaterial(Material.COOKED_COD)
        COOKED_CARROT = Item("Cooked Carrot", "cooked_carrot").setBaseMaterial(Material.COOKED_COD)
        STEAMED_BEETROOT = Item("Steamed Beetroot", "steamed_beetroot").setBaseMaterial(Material.COOKED_COD)
        WOOL = Item("Wool", "wool_item")
        COOKED_CALAMARI = Item("Cooked Calamari", "c_calamari").setBaseMaterial(Material.COOKED_COD)
        POUCH = Item("Pouch", "pouch")
        CALAMARI = Item("Calamari", "calamari").setBaseMaterial(Material.PUFFERFISH)
        ...
        COPPER_PICKAXE = Item("Copper Pickaxe", "copper_pickaxe").setBaseMaterial(Material.STONE_PICKAXE)
        COPPER_AXE = Item("Copper Axe", "copper_axe").setBaseMaterial(Material.STONE_AXE)
        COPPER_SWORD = Item("Copper Sword", "copper_sword").setBaseMaterial(Material.STONE_SWORD)
        COPPER_HOE = Item("Copper Hoe", "copper_hoe").setBaseMaterial(Material.STONE_HOE)
        COPPER_SHOVEL = Item("Copper Shovel", "copper_shovel").setBaseMaterial(Material.STONE_SHOVEL)
